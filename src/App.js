...
class App extends Component {
  constructor() {
    ...
    this.clientId =
      "355188835704-4vqgs6qs2ns6q7rdrrijkebqj6jc6uqi.apps.googleusercontent.com";
    this.spreadsheetId =
      process.env.REACT_APP_SHEET_ID ||
      "1-uiLOn4LRpkb2Oovzg8JG2zafubfuLEtmpfYqjRcdJI";
  ...
  componentDidMount() {
    ...
    window.onload = function () {
      window.google.accounts.id.initialize({
        client_id: "355188835704-4vqgs6qs2ns6q7rdrrijkebqj6jc6uqi.apps.googleusercontent.com",
  ...
  handleExpenseDelete = (expense) => {
    ...
    window.google.accounts.oauth2.CodeClient.sheets.spreadsheets
      .batchUpdate({
  ...
  append(expense) {
    return window.google.accounts.oauth2.CodeClient.sheets.spreadsheets.values.append({
      spreadsheetId: this.spreadsheetId,
      range: "Expenses!A1",
  ...
  update(expense) {
    return window.google.accounts.oauth2.CodeClient.sheets.spreadsheets.values.update({
      spreadsheetId: this.spreadsheetId,
      range: expense.id,
      valueInputOption: "USER_ENTERED",
      values: [this.formatExpense(expense)]
  ...
  load() {
    window.google.accounts.oauth2.CodeClient.sheets.spreadsheets.values
      .batchGet({
        spreadsheetId: this.spreadsheetId,
        ranges: [
          "Data!A2:A50",
